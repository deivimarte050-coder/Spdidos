...
exports.onAdminNotificationCreated = exports.onOrderUpdate = exports.onNewOrder = void 0;
...
exports.onNewOrder = (0, firestore_1.onDocumentCreated)('orders/{orderId}', async (event) => {
    ...
    await sendTo(tokens, '¡Nuevo Pedido! 🔔', `${order['clientName']} — RD$ ${Number(order['total'] ?? 0).toFixed(0)}`, 'new-order');
});
...
exports.onOrderUpdate = (0, firestore_1.onDocumentUpdated)('orders/{orderId}', async (event) => {
    ...
    if (after['status'] === 'arrived') {
        ...
        await sendTo(tokens, '¡Tu repartidor llegó! 🛵', 'Está en tu puerta esperando — abre la app para confirmar', 'arrived');
        return;
    }
});
